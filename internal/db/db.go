...
func ConnectDB() (*gorm.DB, error) {
	...
	db.AutoMigrate(entities.ExampleEntity{}, entities.AccountEntity{}, entities.BalanceEntity{}, entities.TransactionEntity{}, entities.TransactionOnChain{}, entities.TransactionOffChain{})
